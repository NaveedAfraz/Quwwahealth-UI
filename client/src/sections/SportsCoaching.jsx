        ...
        <div className="grid md:grid-cols-2 gap-x-16 lg:gap-x-24 xl:gap-x-32 gap-y-12 md:gap-y-16 lg:gap-y-20">
          ...
          <div className="flex flex-col items-start text-left">
            <div className="flex-grow">
              <h3 className="text-2xl sm:text-2xl md:text-3xl lg:text-4xl mb-4 font-semibold text-gray-900 leading-tight">
                Sports Coaching
              </h3>
              ...
              <div className="w-2/3 sm:w-3/4 md:w-3/5 lg:w-4/6 h-1 bg-[#F3F25B] mb-2"></div>
              <ul className="text-[#848383]  text-base sm:text-sm md:text-md lg:text-md xl:text-lg mb-2 sm:mb-4 md:mb-6 lg:mb-8 list-disc list-inside  leading-relaxed">
                <li>Soccer</li>
                <li>Basketball</li>
                <li>Tennis</li>
                <li>Volleyball</li>
            ...
            <button className="bg-[#F3F25B] text-gray-900 font-[600] text-base sm:text-sm md:text-md lg:text-lg py-2 sm:py-2 md:py-2 px-4 sm:px-6 md:px-8 lg:px-10 rounded-xl shadow-md hover:bg-yellow-400 transition-all duration-300 hover:scale-105">
              View More
            </button>
          </div>
          ...
          <div className="flex flex-col items-start text-left">
            <div className="flex-grow">
              ...
              <div className="w-2/3 sm:w-3/4 md:w-3/5 lg:w-4/6 h-1 bg-[#F3F25B] mb-2"></div>
              <p className="text-[#848383] text-base sm:text-sm md:text-md lg:text-md xl:text-lg mb-4 sm:mb-4 md:mb-6 lg:mb-8 leading-relaxed">
