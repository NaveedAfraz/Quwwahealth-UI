...
const ExpertCoaching = () => {
  return (
    <section className="py-1 px-0 md:px-12 lg:px-22 xl:px-25">
        ...
        <div className="grid md:grid-cols-2 gap-x-16 lg:gap-x-24 xl:gap-x-32 gap-y-12 md:gap-y-16 lg:gap-y-20">
          ...
          <div className="flex flex-col items-start text-left">
            <div className="flex-grow">
              <h3 className="text-2xl sm:text-center md:text-left sm:text-2xl md:text-4xl lg:text-4xl font-semibold text-black leading-tight">
                Expert Coaching & Aligned Curriculum
              </h3>
              <div className="w-32 sm:w-40 md:w-48 lg:w-56 h-1 bg-[#F3F25B] my-2 sm:my-2 md:my-3"></div>
              <p className="text-[#848383] text-base sm:text-sm md:text-md lg:text-lg font-light mb-6 sm:mb-8 md:mb-10 lg:mb-12  ">
          ...
          <div className="flex flex-col items-start text-left">
            <div className="flex-grow">
              <h3 className="text-2xl sm:text-center md:text-left sm:text-4xl md:text-4xl lg:text-4xl font-semibold text-black leading-tight">
