        ...
        <div className="grid md:grid-cols-2 gap-x-16 lg:gap-x-24 xl:gap-x-32 gap-y-12 md:gap-y-16 lg:gap-y-20">
          ...
          <div className="flex flex-col items-start text-left">
            <div className="flex-grow">
              ...
              <div className="w-32 sm:w-40 md:w-48 lg:w-56 h-1 bg-yellow-50 my-4 sm:my-6 md:my-8"></div>
              <p className="text-[#848383] text-base sm:text-sm md:text-md lg:text-lg mb-6 sm:mb-8 md:mb-10 lg:mb-12 leading-relaxed">
